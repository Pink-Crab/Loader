...
class Test_Hook_Loader extends WP_UnitTestCase
{
    ...
    public function test_add_actions(): void
    {
        ...
        $this->assertEquals(1, Arr\filterCount(function($e){
            return $e->get_type() === Hook::ACTION && $e->get_handle() === 'global_action';
        })($hooks->export()));

        $this->assertEquals(1, Arr\filterCount(function($e){
            return $e->get_type() === Hook::ACTION && $e->get_handle() === 'admin_action';
        })($hooks->export()));

        $this->assertEquals(1, Arr\filterCount(function($e){
            return $e->get_type() === Hook::ACTION && $e->get_handle() === 'front_action';
        })($hooks->export()));
    }
        ...
        public function test_add_filters(): void
        {
            ...
            $this->assertEquals(1, Arr\filterCount(function($e){
                return $e->get_type() === Hook::FILTER && $e->get_handle() === 'global_filter';
            })($hooks->export()));
    
            $this->assertEquals(1, Arr\filterCount(function($e){
                return $e->get_type() === Hook::FILTER && $e->get_handle() === 'admin_filter';
            })($hooks->export()));
    
            $this->assertEquals(1, Arr\filterCount(function($e){
                return $e->get_type() === Hook::FILTER && $e->get_handle() === 'front_filter';
            })($hooks->export()));
        }
        ...
        public function test_remove_hook(): void
        {
            ...
            $this->assertEquals(1, Arr\filterCount(function($e){
                return $e->get_type() === Hook::REMOVE && $e->get_handle() === 'hookk';
            })($hooks->export()));
    
            $this->assertEquals(1, Arr\filterCount(function($e){
                return $e->get_type() === Hook::REMOVE && $e->get_handle() === 'filter_hook';
            })($hooks->export()));
    
            $this->assertEquals(1, Arr\filterCount(function($e){
                return $e->get_type() === Hook::REMOVE && $e->get_handle() === 'action_hook';
            })($hooks->export()));
        }
        ...
        public function test_shortcode(): void
        {
            ...
            $this->assertEquals(1, Arr\filterCount(function($e){
                return $e->get_type() === Hook::SHORTCODE && $e->get_handle() === 'my_shortcode';
            })($hooks->export()));
        }
}
